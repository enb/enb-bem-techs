...
module.exports = inherit(/** @lends Level.prototype */{
    ...
    /**
     * Processes the file, adds it to `blocks` filed.
     *
    ...
    /**
     * Loads files and dirs in modifier directory.
     *
     * @param {String} parentElementName
     * @param {String} elementName
     * @param {String} modName
    ...
    /**
     * Loads files and dirs in element or block directory (if `parentElementName` is not specifed).
     *
     * @param {String} parentElementName
     * @param {String} elementName
