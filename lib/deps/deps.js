/**
 * Utils for work with dependencies.
 *
 * @namespace deps
 */
module.exports = {
    ...
    /**
     * Transpiles declaration from BEMDECL format to DEPS format (not resolve).
     *
     * @memberof deps
    ...
    /**
     * Transpiles declaration from DEPS format to BEMDECL format (not resolve).
     *
     * @memberof deps
     * @param {Object} deps
     * @returns {Array}
